...
def build_work(url, html):
    ...
    n_words = stats.pop('words', None)
    n_kudos = stats.pop('kudos', None)
    n_comments = stats.pop('comments', None)
    n_bookmarks = stats.pop('bookmarks', None)
    n_hits = stats.pop('hits', None)
